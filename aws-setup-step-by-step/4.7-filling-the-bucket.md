...
This has been adapted from other init scripts taken from my VPN servers, I won't dive into the details there.
...
# The CRL must be regularly refreshed (in case it changed) !
...
![The main initialization script, stored &quot;as-is&quot;.](../.gitbook/assets/image%20%2881%29.png)

## Files for OpenVPN go in conf
...
![conf : most of OpenVPN required files](../.gitbook/assets/image%20%28102%29.png)
...
{% hint style="success" %}
**...and with that, our S3 bucket "image" is ready for transfer to S3 :**
{% endhint %}
