...
Just copy/paste to the **`init`** sub-folder and give it the _**proper name**_ : it must be the same as what you see at _**line 34 of the userdata**_ script above : **`fgovpn001-init.sh`**
...
![The main initialization script, stored &quot;as-is&quot;.](../.gitbook/assets/image%20%2867%29.png)
