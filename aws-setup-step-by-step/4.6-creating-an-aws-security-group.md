...
![Authorized Outbound traffic : All / Anywhere](../.gitbook/assets/image%20%2888%29.png)
...
![Red: delete rule, Orange : add rule, Blue : change some details](../.gitbook/assets/image%20%2896%29.png)
...
![Our required S.G. rules for FG + OpenVPN from any IPv4](../.gitbook/assets/image%20%2834%29.png)
