...
![Authorized Outbound traffic : All / Anywhere](../.gitbook/assets/image%20%2893%29.png)
...
![Red: delete rule, Orange : add rule, Blue : change some details](../.gitbook/assets/image%20%28102%29.png)
...
![Our required S.G. rules for FG + OpenVPN from any IPv4](../.gitbook/assets/image%20%2837%29.png)
