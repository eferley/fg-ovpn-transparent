...
![The interactive AWS EC2 &quot;Launch Instance&quot; process flow](../.gitbook/assets/image%20%2835%29.png)
...
![Top of the Create Launch Template entry form](../.gitbook/assets/image%20%28101%29.png)
...
![Launch template contents](../.gitbook/assets/image%20%2861%29.png)
...
![t3.micro is the &quot;free elligible&quot; instance type in Stockholm \(2019/07\)](../.gitbook/assets/image%20%2812%29.png)

### Key pair name

[We only created 1 Key pair](4.5-creating-an-aws-key-pair.md), so this is an easy choice...

![Select your \(only\) Key pair name](../.gitbook/assets/image%20%28156%29.png)
...
![VPC !](../.gitbook/assets/image%20%28103%29.png)
...
![IAM instance profile : our IAM role created earlier](../.gitbook/assets/image%20%2895%29.png)
...
![Our customized userdata contents](../.gitbook/assets/image%20%28124%29.png)

## Now, we can confirm our choices !

By clicking the blue "**Create launch template**" button at the bottom...

![Launch Template successfully created](../.gitbook/assets/image%20%2856%29.png)
