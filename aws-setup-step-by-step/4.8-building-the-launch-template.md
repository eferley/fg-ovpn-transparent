...
![The interactive AWS EC2 &quot;Launch Instance&quot; process flow](../.gitbook/assets/image%20%2827%29.png)

We'll use this process in the "**First Test**" of our setup, but for regular usage we should have some simpler way of running our server, so...
...
![Top of the Create Launch Template entry form](../.gitbook/assets/image%20%2878%29.png)
...
![Launch template contents](../.gitbook/assets/image%20%2846%29.png)
...
![t3.micro is the &quot;free elligible&quot; instance type in Stockholm \(2019/07\)](../.gitbook/assets/image%20%289%29.png)

### Key pair name

[We only created 1 Key pair](4.5-creating-an-aws-key-pair.md), so this is an easy choice...

![Select your \(only\) Key pair name](../.gitbook/assets/image%20%28123%29.png)
...
![VPC !](../.gitbook/assets/image%20%2880%29.png)
...
![IAM instance profile : our IAM role created earlier](../.gitbook/assets/image%20%2873%29.png)
...
![Our customized userdata contents](../.gitbook/assets/image%20%2896%29.png)

## Now, we can confirm our choices !

By clicking the blue "**Create launch template**" button at the bottom...

![Launch Template successfully created](../.gitbook/assets/image%20%2842%29.png)
